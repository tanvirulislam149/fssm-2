...
export default function CustomizedHook({ setData, placeholder, content, currentData }) {
  ...
  React.useEffect(() => {
    ...
    setTimeout(() => {
      setOpened(!opened);
      document.getElementById('demo4') && document.getElementById('demo4').click();
    }, 2);
  }, [content, currentData])
